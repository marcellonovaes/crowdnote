...
//app.use(cors({origin: 'https://ufes.gitlab.io'}));
app.use(cors({origin: '*'}));

app.use(function(req, res, next) {
   	//res.header("Access-Control-Allow-Origin", "https://ufes.gitlab.io");
   	res.header("Access-Control-Allow-Origin", "*");
    	res.header('Access-Control-Allow-Methods', 'OPTIONS, SET, GET, POST');
...
app.get('/libras', function(req, res) {
        res.render('ejs/'+project+'/task_'+activeTask, null);
});
...
https.createServer({
        ...
        key: fs.readFileSync('../../ssl/crowdnoter.app.key'),
        cert: fs.readFileSync('../../ssl/crowdnoter.app.crt')
},app).listen(443);
